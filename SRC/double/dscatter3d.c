...
//    printf("Thread's ID %lld \n", thread_id);
    ...
    dblock_gemm_scatter( lb, j, HyP->Ublock_info, HyP->lookAhead_info,
                        (double *)HyP->lookAhead_L_buff, HyP->Lnbrow,
                        (double *)HyP->bigU_host, HyP->ldu,
                                ...
                                )
{
    ...
    //unsigned long long t1 = _rdtsc();
    double t1 = SuperLU_timer_();
    dblock_gemm_scatter( lb, j, HyP->Ublock_info_Phi, HyP->lookAhead_info, (double *)HyP->lookAhead_L_buff, HyP->Lnbrow,
                        (double *)HyP->bigU_Phi, HyP->ldu_Phi,
                                  ...
                                  )
{
    ...
    //unsigned long long t1 = _rdtsc();
    double t1 = SuperLU_timer_();
    dblock_gemm_scatter( lb, j, HyP->Ublock_info, HyP->Remain_info, (double *)HyP->Remain_L_buff, HyP->Rnbrow,
                        (double *)HyP->bigU_host, HyP->ldu,
                        bigV, knsupc,  klst, lsub,  usub, ldt, thread_id, indirect, indirect2,
                        Lrowind_bc_ptr, Lnzval_bc_ptr, Ufstnz_br_ptr, Unzval_br_ptr, xsup, grid, stat
#ifdef SCATTER_PROFILE
                                   ...
                                   )
{
   ...
   // printf("Thread's ID %lld \n", thread_id);
    //unsigned long long t1 = _rdtsc();
    double t1 = SuperLU_timer_();
    dblock_gemm_scatter( lb, j, HyP->Ublock_info_Phi, HyP->Remain_info, (double *)HyP->Remain_L_buff, HyP->Rnbrow,
                        (double *)HyP->bigU_Phi, HyP->ldu_Phi,
                        bigV, knsupc,  klst, lsub,  usub, ldt, thread_id, indirect, indirect2,
                        Lrowind_bc_ptr, Lnzval_bc_ptr, Ufstnz_br_ptr, Unzval_br_ptr, xsup, grid, stat
#ifdef SCATTER_PROFILE
