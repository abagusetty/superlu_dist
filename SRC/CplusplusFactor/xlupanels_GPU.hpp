...
struct xLUstructGPU_t
{
    ...
    //    Ftype* dFBufs[MAX_GPU_STREAMS];
    // Ftype* gpuGemmBuffs[MAX_GPU_STREAMS];
    Ftype **dFBufs;       
    Ftype ** gpuGemmBuffs;
